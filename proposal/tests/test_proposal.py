...
class InvalidProposalRootTestCase(TestCase):
    ...
    def test_category_directory_with_no_files_raises_exception(self):
        with self.assertRaises(exceptions.TemplateError):
    ...
    def test_improper_yaml_file_raises_exception(self):
        with self.assertRaises(exceptions.ObjectError):
