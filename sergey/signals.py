...
def void_embed_data_on_source_url_change(sender, instance, **kwargs):
    """
...
@receiver(pre_save, sender=Video)
def force_video_draft_state(sender, instance, **kwargs):
    """
    ...
    :param instance: ``richard.videos.models.Video`` instance
    """
    if instance.source_url and not instance.embed:
